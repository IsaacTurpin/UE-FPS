...
void UShooterReticle::OnTargetingPlayerStatusChanged(bool bTargeting)
{
	...
	if (CurrentReticle_DynMatInst.IsValid())
	{
		FLinearColor ReticleColour = bTargetingPlayer ? FLinearColor::Red : FLinearColor::White;
		CurrentReticle_DynMatInst->SetVectorParameterValue(Reticle::Inner_RGBA, ReticleColour);
	}
}
